...
/**
 * Servlet implementation class ReturnList
 */
@WebServlet("/brand/returnList")
public class ReturnList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			// 서비스 호출
			Map<String, Object> result = service.returnOrderListByPage(params);

			// JSP로 전달
			request.setAttribute("returnOrderList", result.get("returnOrderList"));
			...
			request.getRequestDispatcher("/brand/returnList.jsp").forward(request, response);
