...
public class Brand {
	...
	public String toString() {
		return "Brand [brandId=" + brandId + ", email=" + email + ", password=" + password + ", brn=" + brn
				+ ", brandName=" + brandName + ", managerName=" + managerName + ", phone=" + phone + ", brandStatus="
				+ brandStatus + ", logoFileId=" + logoFileId + ", heroFileId=" + heroFileId + ", intro=" + intro
				+ ", bank=" + bank + ", accountNumber=" + accountNumber + ", accountHolder=" + accountHolder
				+ ", settlementDate=" + settlementDate + ", createdAt=" + createdAt + ", updatedAt=" + updatedAt + "]";
	}
}
