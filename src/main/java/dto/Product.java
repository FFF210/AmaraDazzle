...
public class Product {
	...
	private Long detail1FileId;
	private Long detail2FileId;
	private Long detail3FileId;
	private Long detail4FileId;
	private Long detail5FileId;
	private Long detail6FileId;
	private Long detail7FileId;
	...
	public Product(Long productId, Long brandId, String name, Integer isExclusive, Integer isVisible, Integer isPlanned,
			Long category1Id, Long category2Id, Long category3Id, Long thumbnailFileId, Long image1FileId,
			Long image2FileId, Long image3FileId, Long image4FileId, Long image5FileId, String ingredients,
			BigDecimal price, Integer orderLimit, Integer hasOption, Integer stockQty, String shippingMethod,
			String discountType, BigDecimal discountValue, Date startDate, Date endDate, Long eventId,
	...
	public Long getDetail1FileId() {
		return detail1FileId;
	}

	public void setDetail1FileId(Long detail1FileId) {
		this.detail1FileId = detail1FileId;
	}

	public Long getDetail2FileId() {
		return detail2FileId;
	}

	public void setDetail2FileId(Long detail2FileId) {
		this.detail2FileId = detail2FileId;
	}

	public Long getDetail3FileId() {
		return detail3FileId;
	}

	public void setDetail3FileId(Long detail3FileId) {
		this.detail3FileId = detail3FileId;
	}

	public Long getDetail4FileId() {
		return detail4FileId;
	}

	public void setDetail4FileId(Long detail4FileId) {
		this.detail4FileId = detail4FileId;
	}

	public Long getDetail5FileId() {
		return detail5FileId;
	}

	public void setDetail5FileId(Long detail5FileId) {
		this.detail5FileId = detail5FileId;
	}

	public Long getDetail6FileId() {
		return detail6FileId;
	}

	public void setDetail6FileId(Long detail6FileId) {
		this.detail6FileId = detail6FileId;
	}

	public Long getDetail7FileId() {
		return detail7FileId;
	}

	public void setDetail7FileId(Long detail7FileId) {
		this.detail7FileId = detail7FileId;
	}
