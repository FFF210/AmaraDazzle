	...
	<my:layout>
		<div class="page-container">
			...
			<div class="page-tableFilter">
				<my:tableFilter
					filters="교환 상태:전체|교환요청|교환승인|회수중|교환배송중|교환완료|교환거절"
					searchItems="주문번호,교환번호,주문자,상품명,회수 운송장번호,교환 운송장번호" />
			</div>
					...
					<table class="table">
						<thead>
							<tr>
								...
								<th class="sortable">교환신청일 <i class="bi bi-dash-lg sort-icon"></i></th>
								<th>주문번호</th>
								<th>교환번호</th>
								<th>주문자</th>
								<th>상품명(옵션)</th>
