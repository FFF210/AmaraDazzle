...
<body>
	<my:layout>
		...
		<div class="wrap">
			...
			<section class="card">
				<div class="head">마케팅 메일 발송</div>
				<div class="body">
					<main>
						<form id="mailForm" method="post" action="sendMail" enctype="multipart/form-data">
							<div class="grid">
								<!-- 템플릿 선택 -->
								...
								<div class="template-tabs" role="tablist" aria-label="메일 유형 선택">
									<button type="button" class="tab is-active"
										data-template="coupon" role="tab" aria-selected="true">할인쿠폰
										안내</button>
									<button type="button" class="tab" data-template="new"
										role="tab" aria-selected="false">신제품 출시 소식</button>
								...
								<div class="inline">
									...
									<label class="inline"> <input type="radio"
										value="birthday" name="target" required checked> 생일
									</label>
								...
								<div class="inline">
									...
									<div id="reserveBox" class="reserve-box" aria-hidden="true">
										<input id="reserveDate" type="date" /> <input
											id="reserveTime" type="time" />
									</div>
								</div>

								<!-- 쿠폰 발급 여부 -->
								<div id="couponIssueLabel" class="label req"
									style="display: none">쿠폰 발급 여부</div>
									...
									<div class="coupon-box" id="couponBox">
										<div class="grid"
											...
											<div class="inline date-row">
												<input id="couponFrom" class="date-start" type="date">
												<span>~</span> <input id="couponTo" class="date-end"
													type="date">
											</div>
								...
								<div class="upload">
									<my:uploader size="lg" id="fileInput1" label="Click to upload"
										desc="또는 파일을 이 영역으로 드래그하세요" name="fileInput1" />
								</div>
