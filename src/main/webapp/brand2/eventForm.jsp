	...
	<my:layout>
		...
		<my:brand2formLayout title="이벤트 신청" formId="eventForm">
			...
			<div class="grid">
				...
				<div>
					<my:selectbox size="lg"
						items="쿠폰,할인,체험단,체험단,이벤트" />
				</div>

				<div class="label req">이벤트명</div>
				<div>
					<my:textInput id="eventName" name="eventName"
						placeholder="이벤트명을 입력하세요." type="default" size="sm"
						state="default" />
				</div>
				...
				<div>
					<div class="product-row">
						<my:textInput id="productInput" name="productInput"
				...
				<div class="label req">쿠폰 발급 여부</div>
				<div class="inline">
					<label class="inline"> <input type="radio" value="Y"
						name="couponIssue" class="form-radio" checked />발급
					</label> <label class="inline"> <input type="radio" value="N"
						name="couponIssue" class="form-radio" checked /> 미발급
					</label>
				</div>
			...
			<div class="footer">
				<button type="button" class="btn btn-outline btn-sm" id="btnClose" onclick="location.href='/brand2/eventList.jsp'">닫기</button>
