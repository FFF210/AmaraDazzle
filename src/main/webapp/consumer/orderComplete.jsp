...
<link rel="stylesheet"
	href="<c:url value='/consumer/css/pageHeader.css'/>">
...
<link rel="stylesheet"
	href="<c:url value='/consumer/css/orderComplete.css'/>">
</head>
...
<body>
	...
	<div class="order-completion-content">
		...
		<div class="main-section">
			<h1 class="completion-message"
				style="color: #111; font-weight: 500; font-size: 32px;">주문이
				완료되었습니다.</h1>
			...
			<div class="order-summary"
				...
				<div
					...
					<strong>최종 결제 금액: <fmt:formatNumber
							value="${orderInfo.order.totalAmount}" pattern="#,###" />원
					</strong>
				</div>
			</div>
			...
			<div
				...
				<button
					onclick="location.href='${pageContext.request.contextPath}/store/mypage/orderDetail?orderId=${orderId}'"
					class="btn btn-primary btn-lg" style="width: 130px;">주문
					상세보기</button>
				<button
					onclick="location.href='${pageContext.request.contextPath}/store/mypage/orderList'"
					class="btn btn-outline btn-lg" style="width: 130px;">주문 목록</button>
				<button
					onclick="location.href='${pageContext.request.contextPath}/store/main'"
					class="btn btn-outline btn-lg" style="width: 130px;">쇼핑
					계속하기</button>
			</div>
		</div>
