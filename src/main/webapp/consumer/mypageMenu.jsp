...
<nav class="mypage-menu" aria-label="마이페이지">
	<a class="mypage-menu_title" href="/store/mypage">마이페이지</a>
  ...
  <section class="menu-group">
    ...
    <ul class="menu-list">
      <li><a class="menu-item ${currentMenu eq 'tickets' ? 'is-active' : ''}"
             href="<c:url value='/store/mypage/ticketList'/>">1:1 문의내역</a></li>
