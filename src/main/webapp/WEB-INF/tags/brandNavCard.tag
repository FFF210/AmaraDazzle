...
<c:set var="logoUrl" value="${empty logoUrl ? 'https://placehold.co/64x64' : logoUrl}" />
...
<div class="brand-link">
  ...
  <!-- 찜 버튼 -->
  <c:import url="/heart-btn.jsp">
    <c:param name="state" value="default" />
    <c:param name="hasCount" value="true" />
  </c:import>
</div>
