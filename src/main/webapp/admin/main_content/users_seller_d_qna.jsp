			...
			<div class="search_container">
				<div class="filter">
					...
					<div class="check_box">
						...
						<div>
							<label> <input type="checkbox" class="" value="" /> 정산
							</label> <label> <input type="checkbox" class="" value="" /> 상품
							</label> <label> <input type="checkbox" class="" value="" /> 판매
							</label> <label> <input type="checkbox" class="" value="" /> 이벤트
							</label> <label> <input type="checkbox" class="" value="" /> 기타
							</label>
						</div>
					</div>
