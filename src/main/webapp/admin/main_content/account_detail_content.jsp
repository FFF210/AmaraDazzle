...
<section class="main_content">
	...
	<div class="description">
		<div>
			...
			<div class="desc">
				1. 순수매출액(수수료 과세 기준) <br /> <i class="bi bi-dot"></i>총매출 100,000,000
				<br /> <i class="bi bi-dot"></i>구매자 배송비 제외 - 2,400,000 <br /> <i
					class="bi bi-dot"></i>플랫폼 쿠폰/포인트 보전 + 300,000 <br /> <i
					class="bi bi-dot"></i>판매자 쿠폰 - 600,000 <br />
				&nbsp;&nbsp;&nbsp;&nbsp;= 97,300,000원 <br />
			</div>
			<div class="desc">
				2. 플랫폼 이용수수료 (7%) <br /> <i class="bi bi-dot"></i>97,300,000 x 7% =
				6,811,000원 <br />
			</div>
			<div class="desc">
				3. 최종 정산액(판매자 수령) <br /> <i class="bi bi-dot"></i>(순수매출액 - 수수료) +
				(구매자 배송비 - 판매자 부담 배송비)<br /> &nbsp;&nbsp;&nbsp;&nbsp;= (97,300,000
				- 6,811,000) + (2,400,000 - 600,000) <br />
				&nbsp;&nbsp;&nbsp;&nbsp;= 90,489,000 + 1,800,000 <br />
				&nbsp;&nbsp;&nbsp;&nbsp;= 92,289,000원
			</div>

			<div class="desc">
				<i class="bi bi-arrow-right-circle"></i> &nbsp;결론 <br /> <i
					class="bi bi-dot"></i>당월 순수매출액: 97,300,000원 <br /> <i
					class="bi bi-dot"></i>판매자 최종 정산액: 92,289,000원<br />
			</div>
		</div>
	</div>
